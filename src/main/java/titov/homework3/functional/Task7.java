...
public class Task7 {
    ...
    public static final Function<List<IntUnaryOperator>, UnaryOperator<List<Integer>>> multifunctionalMapper =
            intOperators -> intList -> intList.stream()
                    .map(n -> intOperators.stream().
     ...
     */
    public static final UnaryOperator<List<Integer>> identityTransformation = ArrayList::new;
